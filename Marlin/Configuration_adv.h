 ...
 *
 * This progrm is distributed in the hope that it will be useful,
...
/**
 * M356 Case Fan on-off / speed
 */
#define CASE_FAN_ENABLE
#if ENABLED(CASE_FAN_ENABLE)
  #define CASE_FAN_PIN 9                  // Override the default pin if needed
  #define INVERT_CASE_FAN false           // Set true if Case Fan is ON when pin is LOW
  #define CASE_FAN_DEFAULT_ON false        // Set default power-up state on
  #define CASE_FAN_DEFAULT_SPEED 255      // Set default power-up speed (0-255, requires PWM pin)
  #define MENU_ITEM_CASE_FAN              // Add a Case Fan option to the LCD main menu
#endif
