...
#define STRING_CONFIG_H_AUTHOR "(mzbot, VORON2)" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "VORON2" // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "mzbot.us"         // will be shown during bootup in line 2
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_VORON2
#endif

// Optional custom name for your RepStrap or other custom machine
// Displayed in the LCD "Ready" message
#define CUSTOM_MACHINE_NAME "VORON2"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 164.71
  #define  DEFAULT_bedKi 16.48
  #define  DEFAULT_bedKd 411.56
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000, 1000, 300, 10000 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (X_BED_SIZE)    // X point for Z homing when homing all axis (G28).
  #define Z_SAFE_HOMING_Y_POINT (Y_BED_SIZE - 35)    // Y point for Z homing when homing all axis (G28).
#endif
...
// affecting heaters, and the fan if FAN_SOFT_PWM isar enabled.
